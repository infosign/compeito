...
| ファイル | 内容 |
|---------|------|
| `docs/cli.md` | CLIコマンド仕様（全コマンドの引数・オプション・出力形式） |
| `docs/import-logic.md` | インポート/エクスポートのビジネスロジック |
| `docs/csv-format.md` | CSVフォーマット仕様 |

**必ず `docs/cli.md` を読んでから実装すること。**
...
1. `docs/cli.md` を読んで全コマンドの仕様を把握する
